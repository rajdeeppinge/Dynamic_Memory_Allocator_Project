 ...
 */
#define WSIZE     sizeof(void *)       /* Word size in bytes */
#define DSIZE     2*WSIZE       /* Double word size in bytes */
#define CHUNKSIZE (1<<12) /* Page size in bytes */
#define MINSIZE   4*WSIZE      /* Minimum block size */
...
#define SET_PTR(p, ptr) ( *(void **)(p) = (ptr))
